...
export const createProductSchema = z.object({
    ...
    quantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).transform(String),
    minimumQuantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).transform(String),
    maximumQuantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).transform(String)
...
export const updateProductSchema = z.object({
    ...
    quantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).optional().transform(String),
    minimumQuantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).optional().transform(String),
    maximumQuantity: z.coerce.number().min(0, 'Quantidade deve ser positiva!').default(0).optional( ).transform(String)
